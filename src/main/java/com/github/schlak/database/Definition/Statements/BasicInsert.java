 ...
 */
public abstract class BasicInsert implements SetTable, SetValue, IQuery {
    ...
    /**
     * Instantiates a new {@link BasicInsert insert builder}. To ensure that all variables are ready to use the
     ...
     * defined table as a new data set. The method is generified to give all classes that inherent {@link BasicInsert this}
     ...
     * @return the {@link BasicInsert actual instance} for chaining the method calls
     */
     ...
     * <p>
     * Set table method grants the set access to the {@link BasicInsert#tableName table name} variable and
     * offers a generified way setting the table name regardless of the database implementation.
     *
     * @param tableName that will be set to the local variable {@link BasicInsert#tableName table name}
     * @return the {@link BasicInsert actual instance} for chaining the method calls
     */
